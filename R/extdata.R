...
#'    \item{\strong{mousebrain/spatial/tissue_hires_image.jpg}: \cr H&E image (2000x1882) pixels}
...
#'    \item{\strong{mousecolon/spatial/tissue_hires_image.jpg}: \cr H&E image (2000x1804) pixels}
