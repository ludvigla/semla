...
#' to each other in an aggregated fashion, as compared to being randomly dispersed throughout
...
#' are randomly dispersed. With the \code{n_permutations} argument, you can specify the number of
