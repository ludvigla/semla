...
NB: The mouse brain test data only includes a subset of the entire data of 188 unique genes. With the
full dataset, we would be able to find a higher optimal rank and therefore obtain more factors.
...
```{r fig.asp=1.2}
MapFeatures(se_mbrain, features = paste0("NMF_", 1:11), pt_size = 2, 
...
```{r}
PlotFeatureLoadings(se_mbrain, dims = 1:2, reduction = "nmf", style = "dots", fill = "steelblue")
```
