...
The same Visium and reference scRNA-seq data sets were used as input for all cell type deconvolution methods tested. The code displayed in the [Cell type mapping with NNLS](https://spatial-research.github.io/semla/articles/cell_type_mapping_with_NNLS.html) vignette was used to produce the NNLS mapping results, while *stereoscope* and *cell2location* were run in python on high-performance computing servers using default parameter settings.
...
se_brain_spatial[["celltypeprops"]] <-
  readRDS(url(file.path("https://github.com/spatial-research/semla/blob/main/vignettes",
...
![1. Correlation plots of cell type mapping results in mouse brain dataset.](../man/figures/compare_cell_type_mapping_NNLS/mbrain_cor_heatmaps.jpg)
...
![2. Comparison of correlation values against NNLS for cell types in mouse brain dataset.](../man/figures/compare_cell_type_mapping_NNLS/mbrain_cor_bars.jpg)
...
```{r results='asis', echo=FALSE, fig.show='show', fig.width=14, fig.height=3.5}
...
![3. Correlation plots of cell type mapping results in mouse kidney dataset.](../man/figures/compare_cell_type_mapping_NNLS/mkidney_cor_heatmaps.jpg)
...
![4. Comparison of correlation values against NNLS for cell types in mouse kidney dataset.](../man/figures/compare_cell_type_mapping_NNLS/mkidney_cor_bars.jpg)
