...
![*Sliced edges are colored in red*](images/cut.png)
...
![*The arrow points at two edges (colored in black) which still connects two separate layers*](images/wrong.png)
