...
![*Sliced edges are colored in red*](../man/figures/images/cut.png)
...
```{r include=FALSE}
tidy_network <- readRDS("R_objects/digital_unrolling_mcolon")
...
![*The arrow points at two edges (colored in black) which still connects two separate layers*](../man/figures/images/wrong.png)
...
![](../man/figures/digital_unrolling/mBrain.jpg)
...
![](../man/figures/digital_unrolling/mBrain_x_dist.jpg)
