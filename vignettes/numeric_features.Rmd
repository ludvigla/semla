...
If you are interested in more advanced features - including details about how to use the patchwork system and other visualization methods - you can skip directly to the ['Advanced visualization' tutorial](https://spatial-research.github.io/semla/articles/advanced_visualization.html).
