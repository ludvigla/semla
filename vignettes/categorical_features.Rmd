...
```{r fig.asp=0.5}
p <- MapLabels(se, column_name = "seurat_clusters", 
               image_use = "raw", pt_alpha = 0.5) &
...
```{r fig.asp=0.8}
p <- MapLabels(se, column_name = "selection", image_use = "raw", 
                 pt_size = 5, section_number = 2, 
...
p_global <- MapLabels(se, column_name = "selection", image_use = "raw",
                        pt_size = 1, section_number = 2, override_plot_dims = TRUE)
p_GALT <- MapLabels(se, column_name = "selection", 
                      image_use = "raw",  pt_size = 5, section_number = 2, 
                      crop_area = c(0.45, 0.55, 0.65, 0.7)) &
