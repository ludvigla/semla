...
In this notebook, we'll have a look at how you can use spatial methods in `STUtility2`. we will continue with the same Seurat object that we created in the '[radial distances](https://ludvigla.github.io/STUtility2/articles/radial_distances.html)' tutorial. If you haven't downloaded and processed the data yet, you should go back to that tutorial before continuing with the analysis presented here.
