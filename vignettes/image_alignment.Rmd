...
![](../man/figures/images/alignment/rotated_and_scaled.png)
...
![](../man/figures/images/alignment/aligned_images.png)
...
![](../man/figures/images/alignment/unique_genes_aligned.jpeg)
...
![](../man/figures/images/alignment/aligned_cropped.jpg)
...
![](../man/figures/images/alignment/alignment_brain_colon.png) If we apply rigid transformations according to the image above, the result will be this:

```{r eval=FALSE}
ImagePlot(se_merged, image_use = "transformed")
```

![](../man/figures/images/alignment/transformed_images_brain_colon.jpg)
