...
This tutorial is an extension of the '[Map numeric features](https://spatial-research.github.io/semla/articles/numeric_features.html)' and '[Map categorical features](https://spatial-research.github.io/semla/articles/categorical_features.html)' tutorials. Here you can find more in depth details about how to manipulate various components of the plots generated with `MapFeatures` and `MapLabels` as well as some additional plot functions.
