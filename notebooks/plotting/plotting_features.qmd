...
cols <- viridis::viridis(n = 11) #c("lightgrey", "mistyrose", "red", "darkred")
...
p_global <- MapFeatures(se, features = c("Ms4a1", "Clu"), 
                        image_use = "raw", scale_alpha = TRUE,
                        pt_size = 1, section_number = 2, color = cols, 
                        override_plot_dims = TRUE)
p_GALT <- MapFeatures(se, features = c("Ms4a1", "Clu"), 
                      image_use = "raw", scale_alpha = TRUE, 
                      pt_size = 3, section_number = 2, 
                      color = cols, crop_area = c(0.45, 0.55, 0.65, 0.7)) &
...
```{r fig.width=6.5, fig.height=6}
p_global <- MapFeatures(se_high_res, features = c("Ms4a1", "Clu"), 
                        image_use = "raw", scale_alpha = TRUE,
                        pt_size = 1, section_number = 2, color = cols, 
                        override_plot_dims = TRUE)
p_GALT <- MapFeatures(se_high_res, features = c("Ms4a1", "Clu"), 
                      image_use = "raw", scale_alpha = TRUE, 
                      pt_size = 3, section_number = 2, 
                      color = cols, crop_area = c(0.45, 0.55, 0.65, 0.7)) &
  theme(plot.title = element_blank(), 
